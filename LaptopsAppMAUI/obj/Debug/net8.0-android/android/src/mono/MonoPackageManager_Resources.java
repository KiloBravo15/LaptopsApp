...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Buchnat.LaptopsApp.MAUI.dll" comes first in this list. */
		"Buchnat.LaptopsApp.MAUI.dll",
		"GoogleGson.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"Buchnat.LaptopsApp.BLC.dll",
		"Buchnat.LaptopsApp.Core.dll",
		"Buchnat.LaptopsApp.Interfaces.dll",
